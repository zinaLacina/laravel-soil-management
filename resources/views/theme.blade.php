...
<html lang="{{ config('app.locale') }}">
	<head>
		...
		<script src="{{ asset('/theme/js/ie-emulation-modes-warning.js') }}"></script>
	...
	<body id="page-top">
		...
		<script src="{{ asset('/theme/js/cbpAnimatedHeader.js') }}"></script>
		<script src="{{ asset('/theme/js/theme-scripts.js') }}"></script>
